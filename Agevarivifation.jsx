...
function ExtensionDatepicker() {
  ...
  const isRajasthan = shippingAddress?.provinceCode?.toLowerCase() === "rj";
   
  console.log(isRajasthan, "isRajasthan");
  ...
  const handleChange = useCallback(async (newValue) => {
    ...
    if (selectedDate > minValidDate) {
      setErrorMessage("S You must be at least 18 years old to proceed");
      return;
    }
